...
- **Inicio de Sesión:** Pantalla de login para acceder a la billetera.
- **Visualización de Saldo:** Muestra el dinero disponible en la cuenta.
- **Transacciones:**
...
- **Bootstrap 5:** Framework para el diseño responsivo y componentes (navbar, botones, formularios).
- **JavaScript:** Lógica de la aplicación y manipulación del DOM.
- **JQuery:** Animaciones y manejo de eventos simplificado.
...
1. Clona este repositorio:
   git clone https://github.com/Benj11ii/billetera-Alke.git
Navega a la carpeta del proyecto.
Abre el archivo login.html (o index.html) en tu navegador web de preferencia.
Desarrollado por Benjamín Carmona para el bootcamp de Alkemy.
